...
def save_crm_notification(pydantic_notif):
    ...
    try:
        fields = dict(
            ...
            recipient_family_id=getattr(pydantic_notif, 'recipient_family_id', None),
            recipient_parent_id=getattr(pydantic_notif, 'recipient_parent_id', None),
            ...
            related_document_id=getattr(pydantic_notif, 'related_document_id', None),
            related_event_id=getattr(pydantic_notif, 'related_event_id', None),
...
def _crm_notification_to_dict(r):
    return {
        ...
        "recipient_family_id": getattr(r, 'recipient_family_id', None),
        "recipient_parent_id": getattr(r, 'recipient_parent_id', None),
        "notification_type": r.notification_type or "tour_scheduled",
        "title": r.title or "",
        "message": r.message or "",
        "related_lead_id": r.related_lead_id,
        "related_document_id": getattr(r, 'related_document_id', None),
        "related_event_id": getattr(r, 'related_event_id', None),
        "read": bool(r.read),
        "created_at": str(r.created_at) if r.created_at else "",
    }
