...
class Student(Base):
    ...
    annual_tuition = Column(Float, default=0.0)
    sufs_approved_amount = Column(Float, default=0.0)
...
class Invoice(Base):
    ...
    billing_type = Column(String, default="OOP")  # OOP, SUFS, Scholarship
    ...
    payment_method = Column(String)  # Stripe, Cash, Check, etc.
